...
<?php
	switch ($_REQUEST["acao"]) {
		...
		case 'editar':
			...
			$sql = "UPDATE aluno SET nome_aluno= '{$nome}', end_aluno='{$end}', email_aluno='{$email}', fone_aluno='{$fone}', nasc_aluno='{$nasc}', genero_aluno='{$gen}' WHERE id_aluno=".$_REQUEST["id_aluno"];
