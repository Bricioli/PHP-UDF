<h1 class="display-6"><i class="far fa-user"></i> Listar Aluno</h1>
<div class="row">
	<div class="col-lg-12">
...
<?php
	...
	if($qtd > 0){
		...
		while($row = $res->fetch_object()){
			...
			print "<td>".ExibeData($row->nasc_aluno)."</td>";
			print "<td>".$row->genero_aluno."</td>";
			print "<td>
					<button class='btn btn-outline-danger' onclick=\"location.href='?page=aluno-editar&id_aluno=".$row->id_aluno."';\">
